...
##              * Condition pour choix de dt et dx : dt/(dx^2) < 1 (CFL)
##              * Avec Euler explicite, pour les pas de temps et d'espace , 
##              j'ai réaliser un grand nombre de tests et finalement opté 
##              pour dt = 0.0005 et dx = 0.01 (mais comme je l'ai expliqué 
##              en commentaires je pense que l'équation de la chaleur 
##              est incorrecte dans le sujet... d'où des observations 
##              incohérentes)
...
file_adress_Euler_explicite = "/Users/jonasamar/Jonasamar_PartageCpp/Matrices/data/cst_test4_Euler_explicite.txt" 
t_f = 0.05
