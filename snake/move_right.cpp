...
// return : rien
// intérêt :  - fait avancer de 1 case le serpent vers la droite  
...
void move_right(std::vector<std::vector<char> > &gameboard,std::vector<std::vector<int> > &serpent,int &game_over)
{
    int speed = 1;
